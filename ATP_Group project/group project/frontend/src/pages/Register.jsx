...
function Register() {
  ...
  async function onSubmit(data) {
    try {
      let api = '/patient-api/register';
      if (role === 'doctor') api = '/doctor-api/register';
      else if (role === 'admin') api = '/admin-api/register';
            ...
            <div className='mb-6'>
              ...
              <div className='grid grid-cols-3 gap-2'>
                {[
                  ...
                  { val: 'doctor',  label: 'Doctor / Staff', icon: FaStethoscope },
